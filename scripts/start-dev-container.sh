...
MOCK_ADDRESS_BOOK_DELAY_MS="${SMARTOFFICE_MOCK_ADDRESS_BOOK_DELAY_MS:-750}"
MOCK_ADDRESS_BOOK_BATCH_SIZE="${SMARTOFFICE_MOCK_ADDRESS_BOOK_BATCH_SIZE:-25}"
...
docker run -d \
  ...
  -e SMARTOFFICE_MOCK_ADDRESS_BOOK_DELAY_MS="${MOCK_ADDRESS_BOOK_DELAY_MS}" \
  -e SMARTOFFICE_MOCK_ADDRESS_BOOK_BATCH_SIZE="${MOCK_ADDRESS_BOOK_BATCH_SIZE}" \
  -p "${HOST_PORT}:2805" \
