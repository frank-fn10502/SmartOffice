...
export function useOutlookDashboard() {
  const {
    ...
    mailDialogVisible, mailDragPreview, mailFetchCountdownTick, mailListMode, mailLookbackHours,
  ...
  return {
    ...
    deleteCalendarEvent, deleteMail, deleteSelectedMails, dragOverFolderPath, draggedMailId, mailDragPreview, expandedFolders, exportMailAttachment,
