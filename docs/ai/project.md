...
- SignalR 用於 Outlook AddIn command/result channel，以及 status、log、progress notification；Web UI 的 folders、mails、rules、categories、calendar、chat 等資料應由 HTTP snapshot 讀回。
